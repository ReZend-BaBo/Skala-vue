...
<template>
  <div class="lifecycle-container">
    ...
    <!-- 실제 컴포넌트 파괴 버튼 -->
    <button class="destroy-button" @click="destroyComponent">
      🔴 실제 컴포넌트 파괴하기 (v-if="false")
    </button>

    <!-- 라이프사이클 탐색 -->
    <div class="section-title">⏱ 라이프사이클 흐름 탐색하기</div>
    ...
    <div class="timer-box">
      ...
      <button class="count-button" @click="increaseCount">수동으로 숫자 올리기</button>
    </div>
  </div>
</template>
